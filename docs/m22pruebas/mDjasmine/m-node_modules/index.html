...
<script src="/lib/js/muestra-codigo.js"></script>
 <title>7. Carpeta « node_modules » - GilPG AWOAS</title>
...
<body  class="xmenu">
 ...
 <a class="anterior" href="/m22pruebas/mDjasmine/m-package-lock-json.html" title="6. package-lock.json"><span class="material-symbols-outlined">
     skip_previous
    </span></a>
...
<nav id="nav">
 <button type="button" title="Cierra" class="cambiaMenu">
  <span class="material-symbols-outlined">
   ...
   <h1><a href="/m22pruebas/mDjasmine/m-node_modules/index.html" class="actual">7. Carpeta « node_modules »</a></h1>
