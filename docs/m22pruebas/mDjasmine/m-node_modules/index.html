...
<head>
 <title>9. Carpeta « node_modules »</title>
 <meta charset="UTF-8">
...
<script src="/lib/js/muestra-codigo.js" defer></script>
 <meta name="description" content="Archivos de la carpeta «node_modules».">
...
<div id="principal">
   <h1 >9. Carpeta « node_modules »</h1>
   <div class="lectura"> 
    <p class="noPrint">
     <a target="_blank" rel="noreferrer"
      href="print.html">Versión para imprimir.</a>
    </p>
   </div>
 ...
 <a class="anterior" href="/m22pruebas/mDjasmine/m-package-lock-json.html" title="8. package-lock.json"><span class="material-symbols-outlined">
     skip_previous
    </span></a>
 <a class="siguiente" href="/m22pruebas/mDjasmine/m-node_modules/m--- No se muestra el contenido de esta carpeta --.html" title="A. node_modules / -- No se muestra el contenido de esta carpeta --"><span class="material-symbols-outlined">
     skip_next
     </span></a>
</div>
...
<nav id="nav">
 <button type="button" title="Cierra" class="cambiaMenu">
  <span class="material-symbols-outlined">
   ...
   <h1><a href="/m22pruebas/mDjasmine/m-node_modules/index.html" class="actual">9. Carpeta « node_modules »</a></h1>
 ...
 /**@type {string} */
 let urlAnterior = "/m22pruebas/mDjasmine/m-package-lock-json.html"
 /**@type {string} */
 let urlSiguiente = "/m22pruebas/mDjasmine/m-node_modules/m--- No se muestra el contenido de esta carpeta --.html"
 /**@type {number|null} */
 let iniciaX = null
 /**@type {number|null} */
 let iniciaY = null
