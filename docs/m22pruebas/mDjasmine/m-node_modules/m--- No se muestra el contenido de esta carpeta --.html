...
<head>
 <title>A. node_modules / -- No se muestra el contenido de esta carpeta --</title>
 <meta charset="UTF-8">
<meta name="theme-color" media="(prefers-color-scheme: light)"
 content="#039623">
<meta name="theme-color" media="(prefers-color-scheme: dark)" content="#039623">
...
<!-- <link rel="preload"
 href="/fonts/MaterialSymbolsOutlined[FILL\,GRAD\,opsz\,wght].woff2" as="font"
 crossorigin>
<link rel="preload"
 href="/fonts/MaterialSymbolsOutlined[FILL\,GRAD\,opsz\,wght].ttf" as="font"
 crossorigin> -->
<link rel="icon" sizes="32x32" href="/favicon.ico">
<link rel="manifest" href="/site.webmanifest">
<script src="/lib/js/muestra-codigo.js" defer></script>
 <meta name="description" content="Código de «node_modules/-- No se muestra el contenido de esta carpeta --».">
 <meta name="og:image" content="https://gilpgawoas.github.io/img/icono/icono2048.png">
 <style>
 ...
 <style>
 /* Activa transiciones de vistas
   * entre documentos para esta
   * página. */
 @view-transition {
  navigation: auto;
 }
 ...
 #nav {
  ...
  transition-duration: var(--navDuracion);
  transition-behavior: allow-discrete;
  transition-timing-function: var(--navFuncion);
 }
...
<div id="principal">
 ...
 <a class="anterior" href="/m22pruebas/mDjasmine/m-node_modules/index.html" title="9. Carpeta « node_modules »"><span class="material-symbols-outlined">
     skip_previous
    </span></a>
 <a class="siguiente" href="/m22pruebas/mDjasmine/m-jsconfig-json.html" title="10. jsconfig.json"><span class="material-symbols-outlined">
     skip_next
     </span></a>
</div>
...
<nav id="nav">
 <button type="button" title="Cierra" class="cambiaMenu">
  <span class="material-symbols-outlined">
   ...
   <p>
    <a href="/"
      data-logo="true">GilPG AWOAS</a>
   </p>
   
   <p>
    <a href="/m22pruebas/">18. Pruebas</a>
   </p>
   <p>
    <a href="/m22pruebas/mDjasmine/">D. Jasmine</a>
   </p>
   
     <p>
      <a class="paginaAnterior" href="/m22pruebas/mDjasmine/m-package-lock-json.html"
        title="8. package-lock.json"><span
        class="material-symbols-outlined">
         arrow_upward
        </span></a>
     </p>
   <h1><a href="/m22pruebas/mDjasmine/m-node_modules/index.html">9. Carpeta « node_modules »</a></h1>
   
   <ol type="A">
    
   <li>
    <p>
     <a href="/m22pruebas/mDjasmine/m-node_modules/m--- No se muestra el contenido de esta carpeta --.html" class="actual">node_modules / -- No se muestra el contenido de esta carpeta --</a>
    </p>
   </li>
   </ol>
   
    <p>
     <a class="paginaSiguiente" href="/m22pruebas/mDjasmine/m-jsconfig-json.html"
       title="10. jsconfig.json"><span
       class="material-symbols-outlined">
        arrow_downward
       </span></a>
    </p>
 ...
 const XMENU = "xmenu"
 const XMENU_UNDO = "xmenu-undo"
 const SCROLL = "scroll"
 const nav = document.querySelector("#nav")

 /**@type {string} */
 let urlAnterior = "/m22pruebas/mDjasmine/m-node_modules/index.html"
 /**@type {string} */
 let urlSiguiente = "/m22pruebas/mDjasmine/m-jsconfig-json.html"
 /**@type {number|null} */
 let iniciaX = null
 /**@type {number|null} */
 let iniciaY = null
 ...
 function cambiaMenu() {
  ...
  if (classList.contains(XMENU)) {
   classList.add(XMENU_UNDO)
  } else {
   classList.remove(XMENU_UNDO)
  }
  classList.toggle(XMENU)
  if (classList.contains(MENU)) {
   classList.add(MENU_UNDO)
  } else {
   classList.remove(MENU_UNDO)
  }
